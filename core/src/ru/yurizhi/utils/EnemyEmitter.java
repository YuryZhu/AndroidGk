...
public class EnemyEmitter {
    ...
    private static final float ENEMY_MIDDLE_HEIGHT = 0.18f;
    private static final float ENEMY_MIDDLE_BULLET_HEIGHT = 0.06f;
    ...
    private static final float ENEMY_BIG_HEIGHT = 0.26f;
    ...
    private TextureRegion bulletRegion1;
    private TextureRegion bulletRegion2;
    ...
    public EnemyEmitter(TextureAtlas atlasBut,TextureAtlas atlas, EnemyPool enemyPool, Rect worldBounds) {
        this.enemyPool = enemyPool;
        TextureRegion textureRegion0 = atlasBut.findRegion("enemy0");
        this.enemySmallRegion = Regions.split(textureRegion0, 1, 2, 2);
        TextureRegion textureRegion1 = atlasBut.findRegion("enemy1");
        this.enemyMiddleRegion = Regions.split(textureRegion1, 1, 2, 2);
        TextureRegion textureRegion2 = atlasBut.findRegion("enemy2");
        this.enemyBigRegion = Regions.split(textureRegion2, 1, 2, 2);
        this.bulletRegion = atlas.findRegion("bulletEnemy");
        this.bulletRegion1 = atlasBut.findRegion("enemy0_bullet");
        this.bulletRegion2 = atlasBut.findRegion("enemy1_bullet");
